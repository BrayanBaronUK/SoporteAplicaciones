...
<head>
  ...
  <title>Creacion Especialista IT AVANTEL</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <div id="content">
        ...
        <section class="form_wrap">
          ...
          <section class="cantact_info">
            ...
            $elusuario = $_SESSION['usuario'];
            $sql = "SELECT CORREO_ELECTRONICO,TELEFONO_DOTACION FROM USUARIOS_SOPORTE WHERE USUARIO = '$elusuario'";
            $resultado_set = oci_parse($conex1, $sql);
            oci_execute($resultado_set);
            while ($row = oci_fetch_array($resultado_set)) {
            ?>
              <p><span class="fa fa-envelope"></span><?php echo $row[0] ?></p>
              <p><span class="fa fa-mobile"></span><?php echo $row[1] ?></p>
              <?php
            }
              ?>
            </section>
    ...
    <script src="./formularios/Creacion_especialista/js/jquery-3.2.1.js"></script>
    <script src="./formularios/Creacion_especialista/js/script.js"></script>
