...
//Consulta
    ...
    setDescription("Reporte de programacion cierres");

    //Establecemos la pestaña activa y nombre a la pestaña
	$objPHPExcel->setActiveSheetIndex(0);
    $objPHPExcel->getActiveSheet()->setTitle("ReporteCierres");
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('B3', 'REPORTE PROGRAMACION CIERRES');
	...
	$objPHPExcel->getActiveSheet()->setCellValue('D6', 'FECHA CIERRE');
   ...
   //$writer->setIncludeCharts(TRUE);
	...
	header('Content-Disposition: attachment;filename="ReporteCierres.xlsx"');
