...
//Consulta
    ...
    $objPHPExcel->getActiveSheet()->setTitle("ReporteVacaciones");
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('B3', 'REPORTE DE VACACIONES');
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('D6', 'INICIO VACACIONES');
    $objPHPExcel->getActiveSheet()->getColumnDimension('E')->setWidth(10);
	$objPHPExcel->getActiveSheet()->setCellValue('E6', 'FIN VACACIONES');
    ...
    $title->setCaption('Gráfico Vacaciones');
   ...
   //$writer->setIncludeCharts(TRUE);
	...
	header('Content-Disposition: attachment;filename="ReporteVacaciones.xlsx"');
