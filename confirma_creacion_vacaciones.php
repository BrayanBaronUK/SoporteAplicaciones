...
while ($row = oci_fetch_array($queryf)){
  ...
  $especSql .= " INTO VACACIONES (USUARIO, ESPECIALISTA, FECHA_REGISTRADO, INICIO_VACACIONES,FIN_VACACIONES) VALUES ('$row[1]', '$row[2]', SYSDATE, '$arrDiasi[$posicionEsp]', '$arrDiasf[$posicionEsp]')";
}
