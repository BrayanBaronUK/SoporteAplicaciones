    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Soporte Aplicaciones TI - Creación de horarios de cierre</h1>
          <p class="mb-4"></p>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Registrar horario de cierre</h6>
            </div>
            <?php
            include_once("conexion.php");
            $conex2 = oci_connect($user, $pass, $db);
            ...
            <div class="card-body">
              <!--tabla compensatorio-->
              <p>
                <form action="confirma_creacion_cierre.php" method="POST">
                  <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
                    <table id="tabla" border=1>
                      <thead>
                        <tr>
                          <th>Fecha cierre maestra</th>
                          <th>Responsable cierre Maestra</th>
