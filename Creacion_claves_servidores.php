    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Soporte Aplicaciones TI - Ingreso credenciales de servidores</h1>
          <p class="mb-4"></p>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Registrar credenciales de servidores</h6>
            </div>

            <div class="card-body">
              <!--tabla compensatorio-->
              <p>
                <form action="confirma_creacion_servidores.php" method="POST">
