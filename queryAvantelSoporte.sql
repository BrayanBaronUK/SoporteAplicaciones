...
/*ARANDA CASOS */
SELECT RESPONSABLE, COUNT(*) FROM ARANDA.V_ARA_CASOS_2 WHERE GRP_ID IN (64,73) AND ESTADO  IN ('SOLUCIONADO','CERRADO') AND
TRUNC(FECHA_REGISTRO) BETWEEN TRUNC (SYSDATE,'MONTH')AND TRUNC(LAST_DAY (SYSDATE))
