...
<head>
  ...
  <title>Soporte IT - Cambio de Contraseña</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-cambio-clave"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">¡¡¡Reinicio de clave correcto!!!</h1>
                    <p class="mb-4">Has reiniciado tu clave, debes indicar una nueva...!</p>
                  </div>
                  <form class="user" action="confirma_cambio_clave.php" method="POST">
