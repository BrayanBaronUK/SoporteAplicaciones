              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Bienvenido al Gestor de Soporte IT</h1>
                  </div>
                 ...
                 <!---   <a href="index.php" class="btn btn-google btn-user btn-block">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="recordar_clave.php">Recordar contraseña</a>
                  </div>
                  <!--
                  <div class="text-center">
