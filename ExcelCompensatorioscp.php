...
//Consulta
    ...
    $objPHPExcel->getActiveSheet()->setTitle("ReporteCompensatorio");
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('B3', 'REPORTE COMPENSATORIOS');
	...
	$objPHPExcel->getActiveSheet()->setCellValue('D6', 'FECHA COMPENSATORIO');
    ...
    $title->setCaption('Gráfico Compensatorios');
   ...
   //$writer->setIncludeCharts(TRUE);
	...
	header('Content-Disposition: attachment;filename="ReporteCompensatorios.xlsx"');
