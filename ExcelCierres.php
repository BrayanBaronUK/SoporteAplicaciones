...
//Consulta
    ...
    setDescription("Reporte de cierres");

    //Establecemos la pestaña activa y nombre a la pestaña
	$objPHPExcel->setActiveSheetIndex(0);
    $objPHPExcel->getActiveSheet()->setTitle("CierresProgramados");
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('D1', 'FECHA CIERRE');
	...
	header('Content-Disposition: attachment;filename="ReporteCierres.xls"');
